...
const NavBar = () => {
  ...
  return (
    <div className='flex gap-2 items-center justify-between border-b pb-2 fixed left-0 w-full top-0 h-[70px] z-100'>
        <div className='flex w-full items-center gap-3 mx-4'>
            <h2 className='font-bold text-3xl italic'>Medium</h2>
            <input className='w-[300px] p-2 focus:outline-none border-none bg-gray-100 rounded' placeholder='Search Here' />
        </div>
